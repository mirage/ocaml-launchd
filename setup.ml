...
(* OASIS_START *)
(* DO NOT EDIT (digest: 08b287a3532cdb9172b986166913dcbf) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Lwt_launchd"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "launchd";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "Launchd Lwt bindings";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "example";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "launchd"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "example";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "launchd_lwt"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "'\030»K\t÷ÿ|AF4\158À¿Â\143";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
